...
- **Chaser** — create step-based chases, define participating controls, add/capture/duplicate/reorder steps, recall saved Pixel Matrix pictures into successive steps, preview recalled chases or individual steps directly on DMX, use browser playback with direction and ping-pong modes, and upload chases into Pico slots for standalone playback.
