...
- **Show Run**, **Chaser**, **Effects**, **Room Plane**, and **DMX Buffer Monitor** currently use the show's first output for direct Pico operations. Their shared header still reports fleet availability, but their live/playback request paths are not yet fully multi-output.
