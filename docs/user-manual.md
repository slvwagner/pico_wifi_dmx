...
- Autonomous **Pico Chaser** and **Pico Effects** playback still targets the show's primary output. Multi-Pico autonomous playback requires coordinated slot payloads and start/stop control across several controllers.
...
The global **Stop All Playback** button calls both playback stop endpoints on the primary Pico. Autonomous multi-Pico Chaser/Effects playback is not yet implemented.
