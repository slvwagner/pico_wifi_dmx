...
5. Finish the installer and select **Open Pico DMX Controller**, or use its desktop/Start Menu shortcut later. The shortcut opens the selected port in a dedicated application window rather than a normal browser tab.
