...
- Hardened Chrome DevTools startup for deterministic screenshot captures with unique temporary profiles, fresh loopback debug ports on retry, retry-on-exit startup, and longer readiness checks.
