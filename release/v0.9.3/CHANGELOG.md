...
- Hardened Chrome DevTools startup for deterministic screenshot captures with unique temporary profiles, loopback-only debug binding, and longer readiness checks.
